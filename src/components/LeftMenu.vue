<template>
  <div
    class="fixed w-full h-[calc(100vh-60px-50px)] md:h-[calc(100vh-60px)] lg:h-[calc(100vh-60px)] flex lg:flex left-0 top-[calc(50px+60px)] md:top-[60px] lg:top-[60px] md:w-[325px] lg:w-[325px] bg-slate-900 border-r-[1px] border-slate-700 flex-col items-start p-6 lg:pl-16 overflow-y-auto z-[20]"
    :style="{
