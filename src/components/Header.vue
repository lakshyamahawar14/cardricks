<template>
  <header
    class="fixed top-0 w-screen h-[60px] bg-slate-900 flex justify-between items-center z-[20] overflow-hidden lg:px-16 px-6 border-b-[1px] border-slate-700"
  >
    ...
    <div class="flex justify-center items-center">
      <a
        ...
        target="blank"
        class="flex justify-center items-center bg-slate-300 hover:bg-slate-400 font-bold p-[2px] rounded"
      >
        <FontAwesomeIcon
          :icon="['fab', 'github']"
